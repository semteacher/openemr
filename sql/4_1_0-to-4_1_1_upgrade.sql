...
ALTER TABLE `patient_data` ADD COLUMN `facilityID` varchar(20) default '0' AFTER ProviderID COMMENT 'store the Facility ID';
#EndIf
...
INSERT INTO `layout_options` (form_id, field_id, group_name, title, seq, data_type, uor, fld_length, max_length, titlecols, datacols, description ) VALUES ('DEM' , 'facilityID', '3Choices', 'Facility', 2, 35, 1, 0, 255, 1, 3, 'Default Facility');
#EndIf
